---
title: 'Agent Trajectory Testing'
description: >-
  An agent that acts can say the right thing and do the wrong thing. Once the
  model can act, the unit of testing becomes the trajectory: the tools it called,
  in what order, whether it confirmed before anything irreversible, and whether a
  retried write applied once. Grade the path, not just the answer.
